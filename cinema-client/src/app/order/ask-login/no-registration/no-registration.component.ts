...
export class NoRegistrationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.orderData = new OrderData(this.orderData.showtimeID, this.orderData.showtimeDate, this.orderData.showtimeTime, this.orderData.orderDataList, this.orderData.totalPrice, this.orderData.pickUpTime, null);
  ...
  guest() {
    ...
    // tslint:disable-next-line:max-line-length
    this.orderData = new OrderData(this.orderData.showtimeID, this.orderData.showtimeDate, this.orderData.showtimeTime, this.orderData.orderDataList, this.orderData.totalPrice, this.orderData.pickUpTime, userInfo);
    sessionStorage.setItem('orderData', JSON.stringify(this.orderData));

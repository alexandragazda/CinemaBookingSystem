...
//        showtimeService.save(new Showtime(LocalDate.of(2020,1,17),LocalTime.of(14,00), Technology.tec_3D, movieService.findById(20), screenService.findById(2)));
...
//    public List<Showtime> showtimes(){return showtimeService.findAll();}
    ...
    public ResponseEntity<List<Showtime>> findByMovieIdAndDate(
        ...
        List<Showtime> showtimes = showtimeService.findByMovieIdAndDate(movieId,date);
